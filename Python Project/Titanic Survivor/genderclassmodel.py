...
os.chdir('C:\Users\uf425c\Documents\Python Projects')

csv_file_object = csv.reader(open('C:/Users/uf425c/Documents/Python Projects/Titanic Survivor/Data/train.csv', 'rb'))       # Load in the csv file
...
# First read in test
test_file = open('C:/Users/uf425c/Documents/Python Projects/Titanic Survivor/Data/test.csv', 'rb')
test_file_object = csv.reader(test_file)
header = test_file_object.next()

# Also open the a new file so I can write to it. 
predictions_file = open("C:/Users/uf425c/Documents/Python Projects/Titanic Survivor/genderclassmodel.csv", "wb")
